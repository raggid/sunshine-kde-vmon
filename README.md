...
```bash
git clone https://github.com/SEU_USUARIO/sunshine-kde-vmon.git
...
Veja `examples/apps.json` para integrar os scripts como `prep-cmd` nos apps Desktop, Desktop Exclusive e Steam Big Picture.
